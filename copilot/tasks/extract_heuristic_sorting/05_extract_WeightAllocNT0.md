# Task 05: Extract `\0` (migrated into library/src/heuristic_sorting; canonical API: CallHeuristic) Function

## Objective
Extract the ``\0` (migrated into library/src/heuristic_sorting; canonical API: CallHeuristic)` function from `moves.cpp` and implement it in the heuristic sorting library.
...
- Look for shared code patterns with ``\0` (migrated into library/src/heuristic_sorting; canonical API: CallHeuristic)`
