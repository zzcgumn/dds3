...
## Acceptance Criteria
- [ ] Document all `WeightAlloc*` functions in `moves.cpp`
...
- Focus on `WeightAlloc*` functions starting around line 2021 in `moves.cpp`
...
- Document any shared state or dependencies between different `WeightAlloc` functions
